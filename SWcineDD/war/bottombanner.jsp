...
<div class="cine_bottom_banner_wrapper">
	<div class="cine_bottom_banner_content">
		<div class="cine_bottom_banner_left">
			<p>
				<a href="http://validator.w3.org/check?uri=http%3A%2F%2Flvaleromsw.appspot.com%2Findex.jsp">Validador HTML5</a>
		...
		<div class="cine_bottom_banner_center">
			...
			<p>
				Copyright (C) 2013 Luis Valero Mart&iacute;;n.
				<br />
				<a rel="license" href="http://www.gnu.org/licenses/gpl.html">
				<img src="../images/gplv3-88x31.png" alt="gplv3"></a>
				<br />El c&oacute;;digo esta bajo una <a rel="license" href="http://www.gnu.org/licenses/gpl.html"> licencia GPLV3</a>
			</p>
